...
message(STATUS "RobotCar: 1 messages, 1 services")

set(MSG_I_FLAGS "-IRobotCar:/home/su/RobotGG_ws/src/RobotCar/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/su/RobotGG_ws/src/RobotCar/msg/carinfo.msg" NAME_WE)
add_custom_target(_RobotCar_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "RobotCar" "/home/su/RobotGG_ws/src/RobotCar/msg/carinfo.msg" ""
)

get_filename_component(_filename "/home/su/RobotGG_ws/src/RobotCar/srv/web2robot.srv" NAME_WE)
add_custom_target(_RobotCar_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "RobotCar" "/home/su/RobotGG_ws/src/RobotCar/srv/web2robot.srv" ""
)
...
_generate_msg_cpp(RobotCar
  "/home/su/RobotGG_ws/src/RobotCar/msg/carinfo.msg"
  "${MSG_I_FLAGS}"
  ""
...
_generate_srv_cpp(RobotCar
  "/home/su/RobotGG_ws/src/RobotCar/srv/web2robot.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/RobotCar
)
